...
import numpy as np
import pandas as pd
from prompts_cube import * 
from prompt_cube_operation_util import doAlgStr, getCube
...
class CubePrompter():
    ...
    def get_goal_state(self) :
        ...
        5 5 
        5 5
        You must make move to the Cube to achieve a Restored State, 
        not limited to the above one. Note that we just need each face to have same numbers, no matter which face has which color.
        """
